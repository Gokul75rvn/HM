...
const medicines_dto_1 = require("./medicines.dto");
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'ADMIN', 'PHARMACIST'),
    (0, swagger_1.ApiOperation)({ summary: 'Create medicine' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [medicines_dto_1.CreateMedicineDto, Object]),
    __metadata("design:returntype", void 0)
], MedicinesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'ADMIN', 'PHARMACIST', 'DOCTOR'),
    (0, swagger_1.ApiOperation)({ summary: 'List medicines' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'ADMIN', 'PHARMACIST'),
    (0, swagger_1.ApiOperation)({ summary: 'Update medicine inventory' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, medicines_dto_1.UpdateMedicineDto, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], MedicinesController.prototype, "lowStock", null);
